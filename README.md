<div align="center">
<h1>@homestuck/configs</h1>

A monorepo of shared tooling configurations used and maintained by members of [@homestuck](https://github.com/homestuck).

[![License: MIT](https://img.shields.io/github/license/homestuck/configs?style=for-the-badge)](https://opensource.org/licenses/MIT)
[![GitHub Actions Workflow Status](https://img.shields.io/github/actions/workflow/status/homestuck/configs/ci.yml?branch=main&style=for-the-badge)](https://github.com/homestuck/configs/actions/workflows/ci.yml?query=branch%3Amain)

</div>

## 📦 Packages

This monorepo contains the following shareable configuration packages:
